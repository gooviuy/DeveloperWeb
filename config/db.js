...
const connectDB = async () => {  // Para conectar con mongoDB (para llamar en server.js)
    try { // si tenemos un error que no podemos conectar, usamos este block cuando usamos async/await
